...
- [shinsenter/defer.js](https://github.com/shinsenter/defer.js) ([3.9.0](https://github.com/shinsenter/defer.js/releases/tag/3.9.0), 4 weeks ago) - 🥇 A small JavaScript library to lazy-load almost anything. Defer.js is dependency-free, efficient, and optimized for Web Vitals.

---

#### 🍊 Latest PRs I published

- [[5.x] Remove redundant command argument (fix #353)](https://github.com/shinsenter/php/pull/354) on [shinsenter/php](https://github.com/shinsenter/php) (today)
...
- [prime-strategy/kusanagi-docker](https://github.com/prime-strategy/kusanagi-docker) - KUSANAGI for Docker (today)
