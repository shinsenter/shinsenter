...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.4.1](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.4.1), 2 days ago) - Easily install PHP extensions in Docker containers
...
- [[5.x] Fixed permission correction flow](https://github.com/shinsenter/php/pull/143) on [shinsenter/php](https://github.com/shinsenter/php) (4 days ago)
- [[5.x] Do not automatically fix ownership when only .env file created](https://github.com/shinsenter/php/pull/142) on [shinsenter/php](https://github.com/shinsenter/php) (6 days ago)
