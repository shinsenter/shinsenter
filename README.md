...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.4.1](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.4.1), today) - Easily install PHP extensions in Docker containers
