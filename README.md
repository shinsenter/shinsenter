...
- [[5.x] Fix tag prefix for stable builds](https://github.com/shinsenter/php/pull/93) on [shinsenter/php](https://github.com/shinsenter/php) (1 day ago)
- [[5.x] Correct tag prefix for the development branch](https://github.com/shinsenter/php/pull/92) on [shinsenter/php](https://github.com/shinsenter/php) (2 days ago)
- [[5.x] Display a greeting when building Docker images](https://github.com/shinsenter/php/pull/91) on [shinsenter/php](https://github.com/shinsenter/php) (2 days ago)
