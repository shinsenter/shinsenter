...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.8.2](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.8.2), today) - Easily install PHP extensions in Docker containers
