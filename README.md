...
- [[5.x] Remove temporary workaround, bump s6-overlay v3.2.3.2](https://github.com/shinsenter/php/pull/429) on [shinsenter/php](https://github.com/shinsenter/php) (5 days ago)
- [[5.x] Fix s6-overlay v3.2.3.1 by hard-coding s6-overlay v3.2.3.0 (temporary workaround)](https://github.com/shinsenter/php/pull/427) on [shinsenter/php](https://github.com/shinsenter/php) (5 days ago)
- [fix: support s6-overlay 3.2.3.1 user-bundles (improves #425)](https://github.com/shinsenter/php/pull/426) on [shinsenter/php](https://github.com/shinsenter/php) (5 days ago)
