...
- [laravel/framework](https://github.com/laravel/framework) ([v10.48.1](https://github.com/laravel/framework/releases/tag/v10.48.1), today) - The Laravel Framework.
- [shinsenter/php](https://github.com/shinsenter/php) ([5.0.3](https://github.com/shinsenter/php/releases/tag/5.0.3), today) - 📦 (PHP) A set of prebuilt PHP Docker images that simplify customization and extension installation.
...
- [[5.x] Add Sulu CMS](https://github.com/shinsenter/php/pull/61) on [shinsenter/php](https://github.com/shinsenter/php) (today)
