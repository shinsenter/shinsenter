...
- [[5.x] Temporary workaround for installing igbinary (re-commit)](https://github.com/shinsenter/php/pull/398) on [shinsenter/php](https://github.com/shinsenter/php) (5 days ago)
- [[5.x] Temporary workaround for installing igbinary](https://github.com/shinsenter/php/pull/397) on [shinsenter/php](https://github.com/shinsenter/php) (5 days ago)
- [[5.x] Remove beta job from template-php.yml](https://github.com/shinsenter/php/pull/396) on [shinsenter/php](https://github.com/shinsenter/php) (5 days ago)
- [fix: remove cleanup of /usr/share/zoneinfo directory (issue #394)](https://github.com/shinsenter/php/pull/395) on [shinsenter/php](https://github.com/shinsenter/php) (6 days ago)
