...
- [laravel/framework](https://github.com/laravel/framework) ([v10.45.1](https://github.com/laravel/framework/releases/tag/v10.45.1), 1 day ago) - The Laravel Framework.
- [shinsenter/php](https://github.com/shinsenter/php) ([5.0.2](https://github.com/shinsenter/php/releases/tag/5.0.2), 1 day ago) - 📦 (PHP) A set of prebuilt PHP Docker images that simplify customization and extension installation.
...
- [Fixes #59](https://github.com/shinsenter/php/pull/60) on [shinsenter/php](https://github.com/shinsenter/php) (1 day ago)
