...
- [laravel/framework](https://github.com/laravel/framework) ([v10.45.0](https://github.com/laravel/framework/releases/tag/v10.45.0), 2 days ago) - The Laravel Framework.
- [shinsenter/php](https://github.com/shinsenter/php) ([5.0.1](https://github.com/shinsenter/php/releases/tag/5.0.1), 6 days ago) - 📦 (PHP) A set of prebuilt PHP Docker images that simplify customization and extension installation.
