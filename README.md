...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.7.1](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.7.1), 1 day ago) - Easily install PHP extensions in Docker containers
...
- [[5.x] Some projects don’t support PHP 8.4 yet, so use PHP 8.3 as the …](https://github.com/shinsenter/php/pull/169) on [shinsenter/php](https://github.com/shinsenter/php) (today)
...
- [[5.x] Remove incompatible build platforms](https://github.com/shinsenter/php/pull/164) on [shinsenter/php](https://github.com/shinsenter/php) (4 days ago)
