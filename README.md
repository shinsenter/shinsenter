...
- [shinsenter/defer.js](https://github.com/shinsenter/defer.js) - 🥇 A small JavaScript library to lazy-load almost anything. Defer.js is dependency-free, efficient, and optimized for Web Vitals. (1 day ago)
...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.8.6](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.8.6), today) - Easily install PHP extensions in Docker containers
- [shinsenter/defer.js](https://github.com/shinsenter/defer.js) ([3.9.0](https://github.com/shinsenter/defer.js/releases/tag/3.9.0), 2 days ago) - 🥇 A small JavaScript library to lazy-load almost anything. Defer.js is dependency-free, efficient, and optimized for Web Vitals.
...
- [[5.x] Some minor enhancements](https://github.com/shinsenter/php/pull/303) on [shinsenter/php](https://github.com/shinsenter/php) (today)
- [[5.x] Force PHP-FPM to load customized config files](https://github.com/shinsenter/php/pull/302) on [shinsenter/php](https://github.com/shinsenter/php) (1 day ago)
- [[5.x] Some minor enhancements](https://github.com/shinsenter/php/pull/299) on [shinsenter/php](https://github.com/shinsenter/php) (1 day ago)
- [[5.x] Continue on outdated build errors](https://github.com/shinsenter/php/pull/298) on [shinsenter/php](https://github.com/shinsenter/php) (2 days ago)
- [For 3.9.0](https://github.com/shinsenter/defer.js/pull/149) on [shinsenter/defer.js](https://github.com/shinsenter/defer.js) (2 days ago)
- [[5.x] Some minor enhancements](https://github.com/shinsenter/php/pull/297) on [shinsenter/php](https://github.com/shinsenter/php) (2 days ago)
- [[5.x] Fix PHP-FPM pool name](https://github.com/shinsenter/php/pull/295) on [shinsenter/php](https://github.com/shinsenter/php) (6 days ago)
