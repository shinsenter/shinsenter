...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.7.37](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.7.37), 3 days ago) - Easily install PHP extensions in Docker containers
...
- [[5.x] Set artifact name and path](https://github.com/shinsenter/php/pull/215) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Fix build errors](https://github.com/shinsenter/php/pull/214) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Optimize build cache](https://github.com/shinsenter/php/pull/213) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Fix double slash issue in the Apache variant (#209)](https://github.com/shinsenter/php/pull/211) on [shinsenter/php](https://github.com/shinsenter/php) (6 days ago)
