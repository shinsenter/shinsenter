...
- [shinsenter/php](https://github.com/shinsenter/php) - 📦 Simplified PHP Docker images for easy customization and extension setup. Supports PHP 5.6 to 8.5 in CLI, ZTS, FPM, FPM/Apache2, FPM/Nginx, RoadRunner and FrankenPHP variants, available in both Debian and Alpine. Built daily. (4 months ago)
...
- [shinsenter/defer.js](https://github.com/shinsenter/defer.js) - 🥇 A small JavaScript library to lazy-load almost anything. Defer.js is dependency-free, efficient, and optimized for Web Vitals. (7 months ago)
...
- [devthefuture-org/dockerfile-x](https://github.com/devthefuture-org/dockerfile-x) - Dockerfile factorization superset (8 months ago)
- [shinsenter/play](https://github.com/shinsenter/play) - My playground with code. (8 months ago)
...
- [shinsenter/php](https://github.com/shinsenter/php) ([5.6.0](https://github.com/shinsenter/php/releases/tag/5.6.0), 5 months ago) - 📦 Simplified PHP Docker images for easy customization and extension setup. Supports PHP 5.6 to 8.5 in CLI, ZTS, FPM, FPM/Apache2, FPM/Nginx, RoadRunner and FrankenPHP variants, available in both Debian and Alpine. Built daily.
- [shinsenter/defer.js](https://github.com/shinsenter/defer.js) ([3.9.0](https://github.com/shinsenter/defer.js/releases/tag/3.9.0), 9 months ago) - 🥇 A small JavaScript library to lazy-load almost anything. Defer.js is dependency-free, efficient, and optimized for Web Vitals.

---

#### 🍊 Latest PRs I published

- [[5.x] Fix composer&#39;s vendor directory path](https://github.com/shinsenter/php/pull/408) on [shinsenter/php](https://github.com/shinsenter/php) (4 months ago)
- [[5.x] Temporary workaround for installing igbinary (re-commit)](https://github.com/shinsenter/php/pull/398) on [shinsenter/php](https://github.com/shinsenter/php) (5 months ago)
- [[5.x] Temporary workaround for installing igbinary](https://github.com/shinsenter/php/pull/397) on [shinsenter/php](https://github.com/shinsenter/php) (5 months ago)
- [[5.x] Remove beta job from template-php.yml](https://github.com/shinsenter/php/pull/396) on [shinsenter/php](https://github.com/shinsenter/php) (5 months ago)
- [fix: remove cleanup of /usr/share/zoneinfo directory (issue #394)](https://github.com/shinsenter/php/pull/395) on [shinsenter/php](https://github.com/shinsenter/php) (5 months ago)

---

#### ⭐️ Recent stars

- [fsylum/rector-wordpress](https://github.com/fsylum/rector-wordpress) - Rector upgrade rules for WordPress (7 months ago)
- [pestphp/pest](https://github.com/pestphp/pest) - Pest is an elegant PHP testing Framework with a focus on simplicity, meticulously designed to bring back the joy of testing in PHP. (7 months ago)
- [github/spec-kit](https://github.com/github/spec-kit) - 💫 Toolkit to help you get started with Spec-Driven Development (7 months ago)
- [karpathy/nanoGPT](https://github.com/karpathy/nanoGPT) - The simplest, fastest repository for training/finetuning medium-sized GPTs. (7 months ago)
- [shinsenter/su-exec](https://github.com/shinsenter/su-exec) - Switch user and group, then exec (binaries only). (8 months ago)
