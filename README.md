...
- [dunglas/frankenphp](https://github.com/dunglas/frankenphp) ([v1.4.1](https://github.com/dunglas/frankenphp/releases/tag/v1.4.1), today) - 🧟 The modern PHP app server
...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.7.13](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.7.13), 1 week ago) - Easily install PHP extensions in Docker containers
