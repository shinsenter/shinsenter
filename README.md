...
- [[5.x] Do not automatically fix ownership when only .env file created](https://github.com/shinsenter/php/pull/142) on [shinsenter/php](https://github.com/shinsenter/php) (1 day ago)
- [[5.x] Allow PHP-FPM pool to run as root](https://github.com/shinsenter/php/pull/141) on [shinsenter/php](https://github.com/shinsenter/php) (2 days ago)
- [[5.x] Fix shebang shell](https://github.com/shinsenter/php/pull/138) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Fix error when fixing letsencrypt](https://github.com/shinsenter/php/pull/137) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Improved debug-echo](https://github.com/shinsenter/php/pull/136) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Request container should be initiated as root](https://github.com/shinsenter/php/pull/135) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Fix permission for su-exec (Alpine Linux only)](https://github.com/shinsenter/php/pull/134) on [shinsenter/php](https://github.com/shinsenter/php) (4 days ago)
- [[5.x] Fix crontab](https://github.com/shinsenter/php/pull/133) on [shinsenter/php](https://github.com/shinsenter/php) (6 days ago)
...
- [songdongsheng/su-exec](https://github.com/songdongsheng/su-exec) - set user and group, then exec (4 days ago)
