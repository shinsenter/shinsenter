...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.5.0](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.5.0), today) - Easily install PHP extensions in Docker containers
