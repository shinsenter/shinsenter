...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.5.3](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.5.3), today) - Easily install PHP extensions in Docker containers
