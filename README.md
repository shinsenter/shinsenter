...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.8.0](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.8.0), 3 days ago) - Easily install PHP extensions in Docker containers
...
- [[5.x] Disable fail-fast to allow all jobs to run, even if some fail](https://github.com/shinsenter/php/pull/217) on [shinsenter/php](https://github.com/shinsenter/php) (3 days ago)
- [[5.x] Optimize build script](https://github.com/shinsenter/php/pull/216) on [shinsenter/php](https://github.com/shinsenter/php) (4 days ago)
