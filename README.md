...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.6.0](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.6.0), today) - Easily install PHP extensions in Docker containers
