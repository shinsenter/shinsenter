...
- [mlocati/docker-php-extension-installer](https://github.com/mlocati/docker-php-extension-installer) ([2.7.8](https://github.com/mlocati/docker-php-extension-installer/releases/tag/2.7.8), today) - Easily install PHP extensions in Docker containers
