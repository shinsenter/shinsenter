...
- [laravel/framework](https://github.com/laravel/framework) ([v10.45.0](https://github.com/laravel/framework/releases/tag/v10.45.0), 1 day ago) - The Laravel Framework.
- [shinsenter/php](https://github.com/shinsenter/php) ([5.0.1](https://github.com/shinsenter/php/releases/tag/5.0.1), 5 days ago) - 📦 (PHP) A set of prebuilt PHP Docker images that simplify customization and extension installation.
...
- [[5.x] Improve debug messages](https://github.com/shinsenter/php/pull/58) on [shinsenter/php](https://github.com/shinsenter/php) (6 days ago)
- [Version 5](https://github.com/shinsenter/php/pull/56) on [shinsenter/php](https://github.com/shinsenter/php) (6 days ago)
