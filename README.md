...
- [shinsenter/docker-squash](https://github.com/shinsenter/docker-squash) - Docker image squashing functionality as an alternative to Docker&#39;s `--squash` flag. It optimizes image sizes while retaining more metadata than `--squash`. (4 days ago)
...
- [laravel/framework](https://github.com/laravel/framework) ([v10.39.0](https://github.com/laravel/framework/releases/tag/v10.39.0), 2 days ago) - The Laravel Framework.
